 ...
 */
  ...
  /********************************************************************/
    ...
    #define VBATSCALE        50 // (*) (**) this value does nothing right now
    #define VBATNOMINAL      42 // 4.2V full battery nominal voltage - only used for lcd.telemetry
    #define VBATLEVEL_WARN1  37 // (*) (**) 3.7V Slow blinking
    #define VBATLEVEL_WARN2  35 // (*) (**) 3.5V Faster blinking
    #define VBATLEVEL_CRIT   31 // (*) (**) 3.1V Very fast blinking
...
/***************************************************************************/
/****           DEFINES FOR ON THE FLY PID TUNING                       ****/
/***************************************************************************/
